...
export function EditDishes() {
  ...
  async function handleSubmit() {
    switch (true) {
      ...
      case dishCategory === 0:
        return toast.error(`Informe a categoria do prato.`, {
          id: "missingInfo",
        })
    }
  ...
  function handleImageKeypress(event) {
    if (event.code === "Space" || event.code === "Enter") event.target.click()
  }
    ...
    <Container>
      ...
      <Content>
              ...
              {ingredients?.length > 0 &&
                ingredients.map((ingredient, idx) => (
                  <NewTag
                    ...
                    onKeyUp={(e) => {
                      if (e.key === "Delete") handleRemoveIngredient(ingredient)
                    }}
                  />
                ))}
        ...
        <div className="buttons">
          <DarkButton onClick={openModal} className="button delete">
            Excluir prato
          </DarkButton>
          <TomatoButton onClick={handleSubmit} className="button save">
            Salvar alterações
          </TomatoButton>
        </div>
        ...
        <Modal isOpen={isModalOpen} close={closeModal}>
          ...
          <div className="buttons">
            ...
            <TomatoButton onClick={() => handleDelete(id)}>
              Excluir
            </TomatoButton>
          </div>
        </Modal>
